...
// Simple div component for layout
...
export default function SolutionTemplate({
  ...
  return (
    <main className="flex-1">
      ...
      {/* Features Section - Only render if features prop is provided */}
      ...
      {/* Benefits Section - Only render if benefits prop is provided */}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Discover how our solution delivers measurable value to healthcare providers
                </p>
              </div>
